    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              ...
              Each scent tells a story, each bottle holds a memory.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-gold-400 transition-colors" aria-label="Facebook">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/shop?category=Unisex" className="text-gray-400 hover:text-white transition-colors">
                  Unisex Fragrances
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} TréchiStore. All rights reserved.</p>
          <p className="mt-2 text-sm">Crafted with love for fragrance lovers worldwide.</p>
        </div>
      </div>
    </footer>
  );
